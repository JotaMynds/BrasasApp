...
import PantallasDeCarga.CargaInsertProducto;
...
public class ModificarProductoSQL extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ModificarProductoSQL frame = new ModificarProductoSQL();
	...
	public ModificarProductoSQL() {
		...
		btnNewButton.setBounds(60, 301, 141, 26);
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				CargaInsertProducto a = new CargaInsertProducto();
				a.setVisible(true);
			}
		});
		getContentPane().setLayout(null);
		
		JLabel lblNewLabel_1 = new JLabel("Selecciona el producto para administrarlo:");
		lblNewLabel_1.setForeground(new Color(238, 221, 128));
		lblNewLabel_1.setFont(new Font("Arial", Font.PLAIN, 15));
		lblNewLabel_1.setBackground(new Color(0, 128, 128));
		lblNewLabel_1.setBounds(51, 62, 363, 18);
		...
		btnEliminarProducto.setBounds(272, 301, 141, 26);
		...
		listaProductos.setBackground(new Color(0, 128, 128));
		listaProductos.setForeground(new Color(238, 221, 128));
		listaProductos.setBounds(50, 83, 409, 200);
		getContentPane().add(listaProductos);
		
		//MÉTODO PARA COGER LOS DATOS DE LOS PRODUCTOS
		CogerDatos();
	...
	public void CogerDatos() {
	    ...
	    try {
	        conexion.conectar();
	        ResultSet rs = conexion.ejecutarSelect("SELECT * FROM productos");
