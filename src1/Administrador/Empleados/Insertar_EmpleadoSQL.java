		...
		btnAñadir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (EmpleadoService.validarEdad(edad)) {
						while (rs.next()) {
							if (textFieldNombre.getText().equalsIgnoreCase(rs.getString("Nombre"))
									&& textFieldPrimerApellido.getText()
											.equalsIgnoreCase(rs.getString("Primer_apellido"))
									&& textFieldSegundoApellido.getText()
											.equalsIgnoreCase(rs.getString("Segundo_apellido"))
						...
						if (!encontrado) {
							String sentencia2 = "INSERT INTO empleados(Nombre, Primer_apellido, Segundo_apellido, Edad, Sexo, Fecha_entrada) VALUES ('"
									+ textFieldNombre.getText() + "', '" + textFieldPrimerApellido.getText() + "', '"
									+ textFieldSegundoApellido.getText() + "', " + textFieldEdad.getText() + ", '"
									+ comboBox.getSelectedItem() + "', '" + textFieldFechaEntrada.getText() + "')";
						...
						JOptionPane.showMessageDialog(null, "Edad por debajo del límite(>=16)");
