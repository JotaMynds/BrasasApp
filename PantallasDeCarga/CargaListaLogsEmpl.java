...
import Administrador.Logs.ListaLogsEmplSQL;
import Administrador.Logs.ListaLogsProdSQL;
import Administrador.Productos.ModificarProductoSQL;
import Cliente.PagoSQL;

public class CargaListaLogsEmpl extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
			try {
				CargaListaLogsEmpl frame = new CargaListaLogsEmpl();
...
////////////////////////////////////////////////////////////////////////////
	...
	public CargaListaLogsEmpl() {
		...
		JLabel lblCargando = new JLabel("Cargando Logs de Empleados...");
		...
		Timer timer = new Timer(100, e -> {
			...
			if (progress[0] <= 100) {
				...
				dispose();
				ListaLogsEmplSQL a = new ListaLogsEmplSQL();
				a.setVisible(true);
			}
		});
