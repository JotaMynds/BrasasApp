...
public class CargaInsertEmpleado extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
			try {
				CargaInsertEmpleado frame = new CargaInsertEmpleado();
...
////////////////////////////////////////////////////////////////////////////
	...
	public CargaInsertEmpleado() {
		...
		JLabel lblCargando = new JLabel("Cargando Añadir empleados...");
		...
		Timer timer = new Timer(100, e -> {
			...
			if (progress[0] <= 100) {
				...
				dispose();
				Insertar_EmpleadoSQL a = new Insertar_EmpleadoSQL();
				a.setVisible(true);
			}
		});
