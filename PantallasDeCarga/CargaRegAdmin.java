...
import Administrador.RegAdminSQL;
import Administrador.StaffMenu;
import Cliente.InicioSesionSQL;
import Cliente.PagoSQL;

public class CargaRegAdmin extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
			try {
				CargaRegAdmin frame = new CargaRegAdmin();
...
////////////////////////////////////////////////////////////////////////////
	...
	public CargaRegAdmin() {
		...
		JLabel lblCargando = new JLabel("Cargando pantalla de registro...");
