...
import Administrador.Productos.Insertar_ProductoSQL;
import Administrador.Productos.ListaProductosSQL;
import Administrador.Empleados.Insertar_EmpleadoSQL;
import Administrador.Empleados.ModificarEmpleadoSQL;
import Administrador.Productos.ModificarProductoSQL;
import Cliente.PagoSQL;

public class CargaInsertProducto extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
			try {
				CargaInsertProducto frame = new CargaInsertProducto();
...
////////////////////////////////////////////////////////////////////////////
	...
	public CargaInsertProducto() {
		...
		JLabel lblCargando = new JLabel("Cargando Añadir producto...");
		...
		lblCargando.setBounds(10, 11, 289, 32);
