...
public class CargaListaLogsProd extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
			try {
				CargaListaLogsProd frame = new CargaListaLogsProd();
...
////////////////////////////////////////////////////////////////////////////
	...
	public CargaListaLogsProd() {
		...
		JLabel lblCargando = new JLabel("Cargando Logs de Productos...");
		...
		Timer timer = new Timer(100, e -> {
			...
			if (progress[0] <= 100) {
				...
				dispose();
				ListaLogsProdSQL a = new ListaLogsProdSQL();
				a.setVisible(true);
			}
		});
