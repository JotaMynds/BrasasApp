...
//Botón de pedir
		...
		btnPedir.setSize(93, 20);
		btnPedir.setLocation(173, 253);
		...
		lblFondo.setIcon(new ImageIcon(Carta.class.getResource("/Imagenes/ChatGPT Image 14 may 2025, 12_35_53.png")));
		lblFondo.setBounds(-51, 0, 254, 300);
		contentPane.add(lblFondo);

		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon(Carta.class.getResource("/Imagenes/ChatGPT Image 2.png")));
		lblNewLabel.setBounds(281, 0, 419, 300);
		contentPane.add(lblNewLabel);

		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon(Carta.class.getResource("/Imagenes/ChatGPT Image 3.png")));
		...
		btnPedir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int respuesta = JOptionPane.showOptionDialog(btnPedir, "¿Desea realizar este pedido?", "Pregunta",
				...
				if (respuesta == 0) {
					...
					try {
						conexion.conectar();
						String sentencia = "UPDATE pedidos(Gambas, Croquetas, Quesos, Ensaladilla, Patatas) VALUES ('"
								+"', '"+ textFieldCantidadGambas.getText() + "', '" + textFieldCantidadCroquetas.getText()
								+ "', '" + textFieldCantidadQuesos.getText() + "', '"
								+ textFieldCantidadEnsaladilla.getText() + "', '" + textFieldCantidadPatatas.getText()
								+ "')";
