...
import PantallasDeCarga.CargaCarta;
import PantallasDeCarga.CargaRealizarPedido;
import Conexion.ConexionMySQL;

public class InicioSesionSQL extends JFrame {
	...
	public static int mesaCopy;

	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
			try {
				InicioSesionSQL frame = new InicioSesionSQL();
			...
			public void actionPerformed(ActionEvent e) {				
                ...
                try {
                 ...
                 // VERFICAR OCUPACIÓN DE MESA
                    ...
                    String consulta = "SELECT ID_mesa FROM clientes WHERE ID_mesa = " + mesa;
        			conexion.ejecutarSelect(consulta);
        			ResultSet mesaAfectada = conexion.ejecutarSelect(consulta);
                    ...
                    String sql2 = "INSERT INTO clientes (Nombre, ID_mesa) VALUES ('" + nombre + "', '" + mesa + "')";
                    conexion.ejecutarInsertDeleteUpdate(sql2);
                    //TRANSICIÓN A LA SIGUIENTE VENTANA
                    dispose();
        			conexion.desconectar();
                    CargaCarta a = new CargaCarta();
                    a.setVisible(true);
