...
public class PagoEnEfectivo extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PagoEnEfectivo frame = new PagoEnEfectivo();
	...
	public PagoEnEfectivo() {
		...
		JLabel lblPAGO = new JLabel("¡Pago en efectivo!");
		...
		JLabel lblEfectivo = new JLabel("Su comanda será cobrada en efectivo en breves");
		lblEfectivo.setBounds(97, 110, 508, 14);
		contentPane.add(lblEfectivo);
		
		JLabel lblEFECTIVO_1 = new JLabel("");
		lblEFECTIVO_1.setIcon(new ImageIcon(PagoEnEfectivo.class.getResource("/Imagenes/efetivo.png")));
		...
		lblEsperePacientementeA.setBounds(88, 137, 440, 14);
