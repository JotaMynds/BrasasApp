...
import Administrador.Empleados.ListaEmpleadosSQL;
import Administrador.Productos.ListaProductosSQL;
import Cliente.PagoSQL;

public class CargaEmpleados extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
			try {
				CargaEmpleados frame = new CargaEmpleados();
...
////////////////////////////////////////////////////////////////////////////
	...
	public CargaEmpleados() {
		...
		JLabel lblCargando = new JLabel("Cargando empleados...");
