...
import Administrador.Comandas.Gestor_PedidosSQL;
...
public class CargaGestorComandas extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
			try {
				CargaGestorComandas frame = new CargaGestorComandas();
...
////////////////////////////////////////////////////////////////////////////
	...
	public CargaGestorComandas() {
		...
		JLabel lblCargando = new JLabel("Cargando Gestor de Comandas...");
		...
		Timer timer = new Timer(100, e -> {
			...
			if (progress[0] <= 100) {
				...
				dispose();
				Gestor_PedidosSQL a = new Gestor_PedidosSQL();
				a.setVisible(true);
			}
		});
