...
public class CargaModEmpleado extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
			try {
				CargaModEmpleado frame = new CargaModEmpleado();
...
////////////////////////////////////////////////////////////////////////////
	...
	public CargaModEmpleado() {
		...
		JLabel lblCargando = new JLabel("Cargando Administrador de empleados...");
		...
		Timer timer = new Timer(100, e -> {
			...
			if (progress[0] <= 100) {
				...
				dispose();
				ModificarEmpleadoSQL a = new ModificarEmpleadoSQL();
				a.setVisible(true);
			}
		});
