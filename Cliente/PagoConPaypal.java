...
public class PagoConPaypal extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PagoConPaypal frame = new PagoConPaypal();
	...
	public PagoConPaypal() {
		...
		JLabel lblPAGO = new JLabel("¡Pago con paypal!");
		...
		// IMÁGENES
		lblEFECTIVO.setIcon(new ImageIcon(PagoConPaypal.class.getResource("/Imagenes/Paypal.png")));
		lblEFECTIVO.setBounds(85, 23, 106, 66);
		contentPane.add(lblEFECTIVO);
		
		JLabel lblEfectivo = new JLabel("Su comanda será cobrada con paypal en breves");
		lblEfectivo.setBounds(97, 110, 508, 14);
		contentPane.add(lblEfectivo);
		
		JLabel lblEFECTIVO_1 = new JLabel("");
		lblEFECTIVO_1.setIcon(new ImageIcon(PagoConPaypal.class.getResource("/Imagenes/Paypal.png")));
		...
		lblEsperePacientementeA.setBounds(53, 139, 440, 14);
