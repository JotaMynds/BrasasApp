...
public class PagoConTarjeta extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PagoConTarjeta frame = new PagoConTarjeta();
	...
	public PagoConTarjeta() {
		...
		JLabel lblPAGO = new JLabel("¡Pago con tarjeta!");
		...
		// IMÁGENES
		lblEFECTIVO.setIcon(new ImageIcon(PagoConTarjeta.class.getResource("/Imagenes/mastercard.png")));
		lblEFECTIVO.setBounds(83, 20, 106, 66);
		contentPane.add(lblEFECTIVO);
		
		JLabel lblEfectivo = new JLabel("Su comanda será cobrada con tarjeta en breves");
		lblEfectivo.setBounds(97, 110, 508, 14);
		contentPane.add(lblEfectivo);
		
		JLabel lblEFECTIVO_1 = new JLabel("");
		lblEFECTIVO_1.setIcon(new ImageIcon(PagoConTarjeta.class.getResource("/Imagenes/visa.png")));
		lblEFECTIVO_1.setBounds(356, 14, 106, 66);
		contentPane.add(lblEFECTIVO_1);
		
		JLabel lblEsperePacientementeA = new JLabel("Espere pacientemente a que algún camarero le cobre");
		lblEsperePacientementeA.setBounds(99, 139, 440, 14);
